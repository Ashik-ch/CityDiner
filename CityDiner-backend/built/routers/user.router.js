...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model_1.UserModel.countDocuments()];
            case 1:
                usersCount = _a.sent();
                if (usersCount > 0) {
                ...
                return [4 /*yield*/, model_1.UserModel.create(data_1.Users)];
            case 2:
                _a.sent();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, model_1.UserModel.findOne({ email: email })];
            case 1:
                user = _c.sent();
                _b = user;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, model_1.UserModel.create(newUser)];
            case 4:
                dbUser = _b.sent();
